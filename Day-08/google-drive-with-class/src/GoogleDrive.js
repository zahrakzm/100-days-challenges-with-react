...
export default class GoogleDrive extends Component {
  constructor() {
    ...
    this.state = {
      str: " ",
      classname : { p: true, a: false, v: false },
  ...
  onClick = (e) => {
    e.preventDefault();
    let finalUrl = "";
    if (this.state.str.includes("https://drive.google.com/file/d/")) {
    ...
    const code = (dl.value = finalUrl + getFileIdFromDriveUrl(this.state.str));
  ...
  this.setState({classname: {p:true,a:false,v:false}})
  };
  hideEA = () => {
    ...
    this.setState({classname:{p:false,a:false,v:true}})
  ...
  hideEV = () => {
   ...
   this.setState({classname:{p:false,a:true,v:false}})
  };
          ...
          <div id="box">
            <div id="container">
              <nav className="tabs">
                ...
                <span className={'span'}onClick={this.hideVA}>
                  {" "}
             
                  <label className={`tab-one ${this.state.classname.p ? 'active' : ''}`} id="first-tab">
                    {" "}
                ...
                <span className={'span'} onClick={this.hideEV}>
                  <label className={`tab-two ${this.state.classname.a ? 'active' : ''}`} id="second-tab">
                    <FontAwesomeIcon icon={faHeadphonesAlt} />
                    Embed Audio
                  </label>
                </span>
                <span className={'span'} onClick={this.hideEA}>
                  {" "}
                  <label className={`tab-three ${this.state.classname.v ? 'active' : ''}`} id="third-tab">
            ...
            <div id="embeded-section">
              <div className="embed-code" id="pasteLink">
                ...
                <form>
                  ...
                  <span onClick={this.copyEmbededText} className="copy">
                    Copy
                  </span>
                  <hr />
                  <button onClick={this.clearForm} className="clear">
                    Clear Form
                  </button>
                </form>
              </div>
              ...
              <div className="embed-code" id="audioLink">
                ...
                <span onClick ={this.copyEmbededAudioText} className="copy-audio">Copy</span>
              </div>
              {/* Video Section */}
              <div className="embed-code" id="videoLink">
                ...
                <span
                  onClick={this.copyEmbededVideoText}
